...
# -----------------------------------------------------------------------------
# Footer Disclaimer (simple persistent block)
# -----------------------------------------------------------------------------

DISCLAIMER_MD = (
    "<small><em>Disclaimer: FinScope AI is provided for informational and educational purposes only and should not be construed as financial advice. Trading and investing involve substantial risk; consult a licensed professional before making decisions. The creators assume no liability for losses incurred.</em></small>"
)
...
def main():
    ...
    if len(hist) > 1:
        ...
        k2.metric("Price Δ 1‑day", f"{dchg:+.2f}%")
    else:
